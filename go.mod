module github.com/heeser-io/universe-cli

go 1.19

require (
	github.com/fatih/color v1.13.0
	github.com/heeser-io/universe v0.0.0-20230703164343-b138382da68e
...
replace github.com/heeser-io/universe v0.0.0 => ../universe-kubernetes
