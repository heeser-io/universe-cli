...
var (
	...
	ListCmd     = &cobra.Command{
		Use:   "list",
		Short: "list all oauth apps for the current authenticated user",
		Run: func(cmd *cobra.Command, args []string) {
			oauths, err := client.Client.OAuth.List(&v2.ListOAuthParams{
				Filter:      Filter,
				Limit:       Limit,
				Sort:        Sort,
			...
			fmt.Println(string(v2.StructToByte(oauths)))
		},
	}
)
