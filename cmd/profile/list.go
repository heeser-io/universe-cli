...
var (
	...
	ListCmd     = &cobra.Command{
		Use:   "list",
		Short: "list all subprofiles for the current authenticated user",
		Run: func(cmd *cobra.Command, args []string) {
			projects, err := client.Client.Profile.List(&v2.ListProfileParams{
				Filter:      Filter,
				Limit:       Limit,
				Sort:        Sort,
			...
			fmt.Println(string(v2.StructToByte(projects)))
		},
	}
)
